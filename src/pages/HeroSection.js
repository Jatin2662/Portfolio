    ...
    return (
        <div>
            ...
            <section id='about' className='hero-section'>
                ...
                <Parallax speed={-20}>
                    <div className="hero-content">
                        <h1>Jatin Arora</h1>
                        <div>Hello, I am Jatin MERN stack developer. Gaining experience by projects</div>
                    </div>
                </Parallax>
            </section>
            ...
            <section id='contact'>
                ...
                <a href="mailto:jatin@example.com" className="email-link">jatinarora4902@gmail.com</a>
